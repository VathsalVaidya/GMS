                ...
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="membersCollapse">
                            <a class="nav-link px-3 active" href="view_members.php">View Members Data</a>
...
<main class="main-content">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title mb-0">Members Data</h5>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td>
                                                    <a href='update_member.php?user_id=" . $row["user_id"] . "' class='btn btn-sm btn-primary'>Update</a>
                                                </td>"; // Update button
                                            echo "<td>
                                                    <button class='btn btn-sm btn-danger' onclick='confirmDelete(" . $row["user_id"] . ")'>Remove</button>
                                                </td>"; // Remove button
                                            echo "</tr>";
                                        }
                                    } else {
                                        echo "<tr><td colspan='12'>No members found</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to remove the user data?
                </div>
    ...
    <script>
        ...
        function confirmDelete(userId) {
            ...
            document.getElementById("deleteButton").href = "remove_member.php?user_id=" + userId;
